...
@protocol CalendarDataSource, CalendarDelegate;
 ...
 */
@property (nonatomic, assign) CalendarViewHeadStyle headStyle;
 ...
 */
- (void)calendarView:(CalendarView *)calendarView configureCell:(id)cell forDate:(NSDate *)date;
 ...
 */
- (void)calendarView:(CalendarView *)calendarView configureSectionHeaderView:(id)headerView firstDateOfMonth:(NSDate *)firstDateOfMonth;
- (void)calendarView:(CalendarView *)calendarView configureSectionFooterView:(id)headerView lastDateOfMonth:(NSDate *)lastDateOfMonth;
 ...
 */
- (BOOL)calendarView:(CalendarView *)calendarView shouldSelectDate:(NSDate *)date;
 ...
 *  @param date         current date
 */
- (void)calendarView:(CalendarView *)calendarView didSelectDate:(NSDate *)date ofCell:(id)cell;
